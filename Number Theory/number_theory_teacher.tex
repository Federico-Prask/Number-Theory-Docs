...
\usepackage{hyperref}
\hypersetup{colorlinks=true,linkcolor=MidnightBlue,urlcolor=MidnightBlue,bookmarksnumbered=true,pdfauthor={两份原稿合并、校订与教学扩充},pdftitle={数论}}
...
\newtcolorbox{teach}[1][教学提示]{enhanced,breakable,colback=accent!4,colframe=accent!60,boxrule=0.4pt,arc=0mm,title={#1},fonttitle=\bfseries,colbacktitle=accent!12,coltitle=ink,left=2mm,right=2mm}
\newtcolorbox{pitfall}[1][易错点]{enhanced,breakable,colback=warn!4,colframe=warn!60,boxrule=0.4pt,arc=0mm,title={#1},fonttitle=\bfseries,colbacktitle=warn!12,coltitle=ink,left=2mm,right=2mm}
